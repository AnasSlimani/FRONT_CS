...
const slides = [
  ...
  },
  {
    ...
    stats: [
      { icon: <Trophy className="text-teal-400" size={32} />, text: "12 Sports Sections" },
      { icon: <Users className="text-teal-400" size={32} />, text: "850+ Active Members" },
      { icon: <Star className="text-teal-400" size={32} />, text: "40 Years of Sports Excellence" },
    ],
    buttonText: "DISCOVER",
    buttonLink: "/about-us",
  ...
  },
  {
    ...
    description: "Graphs , Statistics and Personal Progress",
    buttonText: "EXPLORE",
